# MADTOM: NOX AI Control Center Plugin

The **NOX AI** plugin (`MADTOM.Plugins.NoxAI`) provides a dedicated control plane for managing local large language models (LLMs), inference engines (Ollama, vLLM, llama.cpp), GPU VRAM allocation, and prompt context pipelines.
